...
class TestAdvancedImages(TestCase):
    ...
    def test_nested_square_brackets(self):
        self.assertMarkdownRenders(
            ...
            """<p><img alt="Text[[[[[[[]]]]]]][]" loading="lazy" src="http://link.com/image.png" /> more text</p>"""
        )
    ...
    def test_mixed_title_quotes3(self):
        self.assertMarkdownRenders(
            ...
            """<p><img alt="Text" loading="lazy" src="http://link.com/with spaces.png" title="&quot;and quotes&quot; 'and title" />"""
            """ more text</p>"""
        )
    ...
    def test_mixed_title_quotes5(self):
        self.assertMarkdownRenders(
            """![Text](http://link.com/with spaces .png'"and quotes" 'and title') more text""",
            """<p><img alt="Text" loading="lazy" src="http://link.com/with spaces .png" title="&quot;and quotes&quot;"""
    ...
    def test_mixed_title_quotes6(self):
        self.assertMarkdownRenders(
            ...
            """<p><img alt="Text" loading="lazy" src="http://link.com/with spaces &quot;and quotes&quot;.png" title="and title" />"""
            """ more text</p>"""
        )
    ...
    def test_misc_img_title(self):
        self.assertMarkdownRenders(
            ...
            """<p><img alt="Image" loading="lazy" src="http://humane man.jpg" title="The most humane man." /></p>"""
        )
